...
<?php
	...
	if(is_post_request()){
		...
		if(isset($_GET["mode"]) && isset($id)){
			...
			$users = find_data('users',['users.id','firstname','username','users.date_created','surname','path','role','status'],'INNER JOIN files ON users.file_id = files.id'," ORDER BY users.id desc",false);
		}
									...
									<div class="card card-shadow mb-4">
							          ...
							          <div class="card-body table-responsive">
                                        <table id="bs4-table" class="table table-bordered table-striped" cellspacing="0" width="100%">
                                            ...
                                            <tbody>
                                                <?php echo users_table_component($users); ?>
                                            </tbody>
                                        </table>
                                    </div>
									</div>
