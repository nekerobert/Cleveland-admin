								...
								<div class="card-body">
									<form id="signupForm1" method="post" class=" right-text-label-form feedback-icon-form" action="#" novalidate="novalidate">
										...
										<div class="form-group row">
											...
											<div class="col-sm-5">
												<input type="text" class="form-control" id="" name="bannerbtn" placeholder="eg: contact us">
											</div>
										</div>
										<div class="form-group row">
											<label class="col-sm-4 control-label" for="">Banner Button Link:</label>
											<div class="col-sm-5">
												<input type="text" class="form-control" id="" name="" placeholder="eg: https://cleveland.com/contact">
											</div>
										</div>
										<div class="form-group row">
