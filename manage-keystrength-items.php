						...
						<div class="row d-flex align-items-center">
							<div class="col-md-6">
								<div class="page-breadcrumb">
									<h1>Manage Keystrength Items</h1>
								</div>
							</div>
                                        ...
                                        <table id="bs4-table" class="table table-bordered table-striped" cellspacing="0" width="100%">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td></td>
                                                    <td>
                                                       <button type="button" class="btn btn-info" data-toggle="modal" data-target="#viewKeystrength" data-whatever="@mdo">View</button>
                                                  </td>
                                                    <td>
						...
						<div class="col-sm-12 col-md-12 col-lg-6 col-xs-12 col-xl-6">
							...
							<div class="col-md-12">
									<div class="card  border-info lobicard-custom-control lobi-light  mb-4">
										<div class="card-header bg-info ">
											<div class="card-title text-white">
												Add Keystrength Items
											</div>
										</div>
								<div class="card-body">
									<form id="signupForm1" method="post" class=" right-text-label-form feedback-icon-form" action="#" novalidate="novalidate">
										<div class="form-group row">
											<label class="col-sm-4 control-label" for="sectitle">Itme Title</label>
											<div class="col-sm-5">
												<input type="text" class="form-control" id="sectitle" name="" placeholder="Item Title">
											</div>
										</div>
										<div class="form-group row">
											<label class="col-sm-4 control-label" for="secdesc">Item Description</label>
											<div class="col-sm-5">
												 <textarea class="form-control" id="editor" name="" placeholder="Item Description"></textarea>
											</div>
										</div>
										<div class="form-group row">
											<label class="col-sm-4 control-label" for="username1">Item Image</label>
											<div class="col-sm-5">
												 <input type="file" multiple class="form-control" id="tipimg" name="tipimg" placeholder="Choose Keystrength image" />
											</div>
										</div>
										<div class="form-group row">
...
<!-- modal starts -->
   					<div class="modal fade" id="viewKeystrength" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
										<div class="modal-dialog" role="document">
											<div class="modal-content">
												<div class="modal-header">
													<h5 class="modal-title" id="exampleModalLabel">View Key Strength Items</h5>
