						...
						<div class="row d-flex align-items-center">
							<div class="col-md-6">
								<div class="page-breadcrumb">
									<h1>Manage Keystrength Section</h1>
								</div>
							</div>
									...
									<div class="card  border-info lobicard-custom-control lobi-light  mb-4">
										<div class="card-header bg-info ">
											<div class="card-title text-white">
												Manage Keystrength Section
											</div>
										</div>
								<div class="card-body">
									<form id="signupForm1" method="post" class=" right-text-label-form feedback-icon-form" action="#" novalidate="novalidate">
										<div class="form-group row">
											<label class="col-sm-4 control-label" for="servetitle">Section Title:</label>
											<div class="col-sm-5">
												<input type="text" class="form-control" id="servetitle" name="servetitle" placeholder="Section Title">
											</div>
										</div>
									...
									<div class="form-group row">
											...
											<div class="col-sm-5">
												 <textarea class="form-control" id="" name="" placeholder="Section Description"></textarea>
											</div>
										</div>
										<div class="form-group row">
